    ...
    <div class="container" style="padding-top: 2rem; padding-bottom: 2rem;">
        ...
        <div class="card">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h2 style="font-size: 1.5rem; font-weight: 700; color: var(--color-text);">Manajemen Lokasi</h2>
                    <p style="color: var(--color-text-muted);">Kelola data lokasi penyimpanan barang</p>
                </div>
                ...
                <table style="width: 100%; border-collapse: collapse; text-align: left;">
                    <thead>
                        <tr style="border-bottom: 2px solid #e2e8f0;">
                            ...
                            <th style="padding: 1rem; font-weight: 600; color: var(--color-text-muted);">Nama Lokasi</th>
                    ...
                    <tbody>
                        @forelse($locations as $index => $location)
                            <tr style="border-bottom: 1px solid #f1f5f9; transition: background 0.2s;">
                                ...
                                <td style="padding: 1rem; font-weight: 500;">{{ $location->name }}</td>
                                <td style="padding: 1rem;">{{ $location->description ?: '-' }}</td>
